...
/// @param {Real} testFunc The function to run for each buffer type (should have the arguments testBuffer, iType, iSize, iTypeString, iAlignment)
...
/// @param {Real} testFunc The function to run for each buffer data type (should have the arguments testBuffer, type, value, typeString, and typeSize)
...
function BasicBufferTestSuite() : TestSuite() constructor {
    ...
    // BASE64 TESTS - SHOULD NOT BE HERE!!!
