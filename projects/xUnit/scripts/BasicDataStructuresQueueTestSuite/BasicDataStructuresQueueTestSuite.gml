...
function BasicDataStructuresQueueTestSuite() : TestSuite() constructor {
	...
	addFact("ds_queue_read_write_test #1", function() {
		...
		var checkGMS2 = "";
		var checkGMRT = "CC000000030000000000000003000000000000000000000000005940000000000000000000006940000000000000000000C07240";
		...
		var checkValue = (os_browser == browser_not_a_browser) ? (runtime_gmrt() ? checkGMRT : checkGMS2 ) : checkBrowser;
