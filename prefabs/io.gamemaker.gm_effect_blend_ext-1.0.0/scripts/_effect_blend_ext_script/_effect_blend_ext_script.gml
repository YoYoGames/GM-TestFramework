function _effect_blend_ext() constructor
{
	g_BlendExt_Src = 2;
	g_BlendExt_Dest = 2;
	g_BlendExt_AlphaSrc = 2;
	g_BlendExt_AlphaDest = 2;
	...
	layer_end = function()
	{
		...
		gpu_set_blendmode_ext_sepalpha(g_BlendExt_Src, g_BlendExt_Dest, g_BlendExt_AlphaSrc, g_BlendExt_AlphaDest);
